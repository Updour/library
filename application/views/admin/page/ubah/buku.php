{form_ubah}<!-- iini bersifat finamis karna akan menggantikan form action
<form action="{index}insert/buku" method="POST" role="form" > -->
	<legend>Form Input Buku</legend>
	{ubah}
	<div class="form-group">
		<label for="">judul buku</label>
		<input type="text"  onkeyup="this.value = this.value.toUpperCase()" class="form-control" name="judul_buku" value="{judul_buku}" placeholder="masukkan judul buku">
	</div>

	<div>
		<label for="">Jumlah Halaman</label>
		<input type="text"  onkeyup="this.value = this.value.toUpperCase()" class="form-control" name="jumlah_halaman" value="{jumlah_halaman}" placeholder="masukkan jumlah halaman">
	</div>
	
	<div>
		<label for="">Penerbit</label>
		<input type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="penerbit" value="{penerbit}" placeholder="masukkan penerbit">
	</div>
	...
	<div>
		...
		<input type="text" onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="kategori" value="{kategori} " placeholder="masukkan kategori">
	</div>
	<br/>
	<div >
	...
	<th><a href="<?=site_url('admin/daftar/buku/{pk_buku}')?>" class="btn btn-warning">Batal Update</a></th>
</form>